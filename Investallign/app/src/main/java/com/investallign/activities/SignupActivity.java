...
import com.investallign.CustomViews.*;
...
public class SignupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageView = (RoundedImageView) findViewById(R.id.user_profile_photo);
    ...
    private void toolbarManagement() {
        ...
        toolBarTtitle.setText("New Account");
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            case UtilityManager.MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE:
    ...
    private void selectImage() {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                boolean result = UtilityManager.checkPermission(SignupActivity.this);
