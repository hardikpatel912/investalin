package com.investallign.CustomViews;
...
public class Ranger extends HorizontalScrollView implements View.OnClickListener {
    ...
    public static TextView mDayNumber;
    /**
     * Constants
     */
    //Layouts
    ...
    public void init(Context context, AttributeSet attributeSet) {
        ...
        if(attributeSet != null) {
            ...
            try {
                ...
                //Colors
                mDayTextColor = a.getColor(R.styleable.Ranger_dayTextColor, getColor(R.color.default_days_container_background_color));
                ...
                mSelectedDayBackgroundColor = a.getColor(R.styleable.Ranger_selectedDayBackgroundColor, getColor(R.color.default_days_container_background_color));
    ...
    private void unSelectDay(int day) {
        for (int i = 1; i < mDaysContainer.getChildCount() - 1; i++) {
            ...
            if(dayView.getDay() == day) {
                ...
                mDayNumber.setBackground(getResources().getDrawable(R.drawable.calenderunselectedbackground));
                return;
            }
        }
    }
...
//                dayView.setBackgroundColor(mSelectedDayBackgroundColor);
                mDayNumber.setBackground(getResources().getDrawable(R.drawable.calenderbackground));
