...
public class TutorialFragment extends Fragment implements OnPageChangeListener {

    private List<Integer> drawbles = new ArrayList<>();
    private ViewPager pager;
    private ViewPagerAdapter adapter;
    private SlidingTabLayout tabs;
    private CharSequence titles[] = {AppConstants.BASIC, AppConstants.ADVANCE, AppConstants.EXPERT};
...
//        HomeActivity.toolbar.setVisibility(View.VISIBLE);
    ...
    private void pagerAndTabsManagement() {
        ...
        pager = (ViewPager) v.findViewById(R.id.fragment_tutorial_pager);
        pager.setAdapter(adapter);
        pager.setOffscreenPageLimit(noOfTabs);

        tabs = (SlidingTabLayout) v.findViewById(R.id.fragment_turorial_tabs);
        ...
        tabs.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ...
                if (selectedFragment instanceof BasicFragment) {
                    ((BasicFragment) selectedFragment).onPage();
                } else if (selectedFragment instanceof AdvanceFragment) {
                    ((AdvanceFragment) selectedFragment).onPage();
                } else if (selectedFragment instanceof ExpertFragment) {
                    ((ExpertFragment) selectedFragment).onPage();
                }
